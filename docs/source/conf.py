...
# -*- coding: utf-8 -*-
#
# coral_documentation documentation build configuration file, created by
...
htmlhelp_basename = 'coral_documentationdoc'
...
man_pages = [
    (master_doc, 'coral_documentation', 'coral_documentation Documentation',
     [author], 1)
]
